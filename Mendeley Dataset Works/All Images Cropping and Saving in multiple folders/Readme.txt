## Folder Name : All Images Cropping and Saving in a multiple Folders
## File Name : Folderwisecropped.ipynb
...
according to its bounding points and also renamed the images with the given labels in the json file and saved the images. in this section we saved all words from different images in a different folders. 
for every paragraph image we had we created a folder and we saved those words in the specified folder.by this way we knew which words contained which paragraph.